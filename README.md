...
This tutorial outlines the post-install configuration of the open-source help desk ticketing system osTicket. This tutorial assumes you have fully completed, installed, set up login credentials, and perform clean up on osTicket in your Virtual Machine environment via following the previous tutorial <a href ="https://github.com/FLATOPA/osticket-prereqs">"osTicket - Prerequisites and Installation"</a><br />
...
<ul>
  ...
  <ul>
    ...
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/6abb22de-3ec5-47a9-8efd-46caf9d1622f" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
  </ul>
  ...
  <ul>
    ...
    <ul>
      ...
      <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/6347ce31-f5f1-4078-b738-dc70dd037df6" alt="Disk Sanitization Steps"/></li>
    </ul>
    ...
    <ul>
      <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/306c368f-76fb-4b25-869b-d1a1f430ed76" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
    </ul>
  </ul>
  ...
  <ul>
    ...
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/2a449d47-9632-47ee-9606-65512e292a2e" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
  </ul>
  ...
  <ul>
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/700f78be-2640-4f34-85d6-0ab8ff6ae994" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
  </ul>
  </ul>
  ...
  <ul>
    ...
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/5ede2f9c-91d5-4f9b-8199-99e8f0696e5c" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
    </ul>
    <li>Name the Team <b>Level II Support</b> then click on <b>Create Team</b> to create the Team</li>
    <ul>
      <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/b9aa5ab2-2c41-4666-a4f2-6a0f3ff88bc1" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
    </ul>
  </ul>
...
<ul>
  ...
  <ul>
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/97c51388-324a-42e0-a808-067de164c4b6" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
  </ul>
</ul>
...
<ul>
  ...
  <ul>
    ...
    <ul>
      <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/d66757f0-54d1-458f-8a2d-4f1890b2da1d" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
    </ul>
    ...
    <ul>
      ...
      <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/06fbd1ca-9d97-4f4f-b866-9b304dbdeb57" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
      ...
      <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/51953148-bddc-476c-9368-4b62f4bf3d42" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
    </ul>
    ...
    <ul>
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/c57bca22-2622-4f01-88eb-bd699d1f12de" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
    </ul>
  ...
  <ul>
    ...
    <ul>
      <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/f08ec067-3a66-420e-bfaf-6a3003512bcb" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
    </ul>
    ...
    <ul>
      <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/8eadff14-b483-4781-9679-80b252a092c4" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
    </ul>
  </ul>
...
<ul>
  ...
  <ul>
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/1ebc6fe9-aa95-4e52-9fd9-1ecd7724d3b9" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/cf8da66d-209b-40e6-a4f1-c99bbd102b3a" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
  </ul>
  ...
  <ul>
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/ee7d6fbb-f67a-4055-aa9b-b9fd77d48de1" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
  </ul>
</ul>
...
<ul>
  ...
  <ul>
    ...
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/27299450-a705-462c-a7d0-6fcdac6f5a59" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
  </ul>
  ...
  <ul>
    <li><img src="https://github.com/FLATOPA/post-install-config/assets/147654000/97777c9e-516c-4831-891b-9d65e9613ed0" height="80%" width="80%" alt="Disk Sanitization Steps"/></li>
  </ul>
...
<h3 align = "right">Next Tutorial - <a href = "https://github.com/FLATOPA/ticket-lifecycle">osTicket: Ticket Lifecycle Examples</a></h3>
